...
public class Ejercicios implements Serializable {
    ...
    String nombre, imagen, video, descripcion, categoria, fecha;
    ...
    public Ejercicios(String nombre, String imagen, String video, String descripcion, String categoria,  String fecha) {
        this.nombre = nombre;
        this.imagen = imagen;
        this.video = video;
