...
public class EjerciciosSeleccionados extends AppCompatActivity implements AdaptadorRecycler_Lista.OnTipoSelectedListener,
    ...
    private void guardarEntrenamiento(String nombre) {
        ...
        refencia.child("Ejercicios Usuarios").child(FirebaseAuth.getInstance().getUid()).child(modelo.obtenerFechaHoy()).child(nombre).setValue(array); //Agregamos el array
        refencia.child("Ejercicios Usuarios").child(FirebaseAuth.getInstance().getUid()).child(modelo.obtenerFechaHoy()).child(nombre).child("nombre").setValue(nombre); //Establecemos un nombre al entrenamiento

        //refencia.child("Ejercicios Usuarios").child(FirebaseAuth.getInstance().getUid()).child(modelo.obtenerFechaHoy()).child(nombre).setValue(nombre);
        //refencia.child(nombre);
    }
